...
int main() {
    ...
    do {
        printf("\n|---WELCOME TO THAI_PS49318 ASSIGNMENT COM108---|\n");
        printf("|------------------MENU---------------------|\n");
        ...
        case 8:
            printf("Chuc nang sap xep sinh vien (dang trong)\n");
            break;

        case 9:
            printf("Game FPOLY-LOTT (dang trong)\n");
            break;

        case 10:
            printf("Chuc nang tinh phan so (dang trong)\n");
            break;
